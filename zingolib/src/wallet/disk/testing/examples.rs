            ...
            NetworkSeedVersion::Regtest(seed) => match seed {
                RegtestSeedVersion::HospitalMuseum(_) => {
                    match pool {
                        ...
                        PoolType::Shielded(ShieldedPool::Ironwood) => {panic!("no ironwood receiver in default unified address")},
                        PoolType::Shielded(ShieldedPool::Orchard) => {"uregtest1ue949txhf9t2z6ldg8wc6s5t439t2hu55yh9l58gc23cmxthths836nxtpyvhpkrftsp2jnnp9eadtqy2nefxn04eyxeu8l0x5kk8ct9".to_string()},
                    }
                },
                RegtestSeedVersion::AbandonAbandon(_) => {
                    match pool {
                        ...
                        PoolType::Shielded(ShieldedPool::Sapling) => {panic!("no sapling receiver in default unified address")},
                        PoolType::Shielded(ShieldedPool::Ironwood) => {panic!("no ironwood receiver in default unified address")},
                        PoolType::Shielded(ShieldedPool::Orchard) => {"uregtest1h8fnf3vrmswwj0r6nfvq24nxzmyjzaq5jvyxyc2afjtuze8tn93zjqt87kv9wm0ew4rkprpuphf08tc7f5nnd3j3kxnngyxf0cv9k9lc".to_string()},
                    }
                },
                RegtestSeedVersion::AbsurdAmount(_) => {
                    match pool {
                        ...
                        PoolType::Shielded(ShieldedPool::Sapling) => {panic!("no sapling receiver in default unified address")},
                        PoolType::Shielded(ShieldedPool::Ironwood) => {panic!("no ironwood receiver in default unified address")},
                        PoolType::Shielded(ShieldedPool::Orchard) => {"uregtest1s79x7etgyc7yl5tpw3vf2k6xa5qqk30de670p68c9tes79p2lkfm0vpy2u34x6wrwaa2fsxayjvz9dshrv92dur3h694v7sqnsgac028".to_string()},
                    }
                },
            },
            NetworkSeedVersion::Testnet(seed) => match seed {
                TestnetSeedVersion::ChimneyBetter(_) => {
                    match pool {
                        ...
                        PoolType::Shielded(ShieldedPool::Sapling) => {panic!("no sapling receiver in default unified address")},
                        PoolType::Shielded(ShieldedPool::Ironwood) => {panic!("no ironwood receiver in default unified address")},
                        PoolType::Shielded(ShieldedPool::Orchard) => {"utest1f7hprvzygjeq6gtyh2splf0qq3ug70krvq44z40d7lg590u2dwg59l8we9v2mdpk72llg5wd9cat68ur0pdrmyx8fs54x6asy5z86elr".to_string()},
                    }
                },
                TestnetSeedVersion::MobileShuffle(_) => {
                    match pool {
                        ...
                        PoolType::Shielded(ShieldedPool::Sapling) => {panic!("no sapling receiver in default unified address")},
                        PoolType::Shielded(ShieldedPool::Ironwood) => {panic!("no ironwood receiver in default unified address")},
                        PoolType::Shielded(ShieldedPool::Orchard) => {"utest1uuwsmtfxnssw7uu664gevkz8xydtcwmt6u0gns95n6pr0vetdpm6mz6ltczk68c0cp8svevr6j4xkps2wdvcrf0gy0lvnfry8qn7gvjc".to_string()},
                    }
                },
                TestnetSeedVersion::GloryGoddess => {
                    match pool {
                        ...
                        PoolType::Shielded(ShieldedPool::Sapling) => {panic!("no sapling receiver in default unified address")},
                        PoolType::Shielded(ShieldedPool::Ironwood) => {panic!("no ironwood receiver in default unified address")},
                        PoolType::Shielded(ShieldedPool::Orchard) => {"utest1dmu08vg5wt5m9w0ejwgeqdndzzkfka7c94heuz5llxv5vx4lhcethmm6p5ean3wcj8l0m6tf8k8cau9r636gq7sxq3wa6zey2sysfteh".to_string()},
                    }
                },
            },
            NetworkSeedVersion::Mainnet(seed) => match seed {
                MainnetSeedVersion::VillageTarget(_) => {
                    ...
                    "t1P8tQtYFLR7TWsqtauc71RGQdqqwfFBbb4".to_string()},
                        PoolType::Shielded(ShieldedPool::Sapling) => {panic!("no sapling receiver in default unified address")},
                        PoolType::Shielded(ShieldedPool::Ironwood) => {panic!("no ironwood receiver in default unified address")},
                        PoolType::Shielded(ShieldedPool::Orchard) => {"u1d6whpxpf9l7k7z9ce85w4w3wgfv0y3h5lm25g7ae7wqryqcy9zf7xwd2k6gpqzhat9den3c8ezk797gvdmrhm6dtuldz3wpj5yf27jd3".to_string()},
                    }
                },
                MainnetSeedVersion::HotelHumor(_) => {
                    match pool {
                        ...
                        PoolType::Shielded(ShieldedPool::Sapling) => {panic!("no sapling receiver in default unified address")},
                        PoolType::Shielded(ShieldedPool::Ironwood) => {panic!("no ironwood receiver in default unified address")},
                        PoolType::Shielded(ShieldedPool::Orchard) => {"u17923s4jdmkcjm8ek8t5elhuejlv8wfhwdqxqewk9meqfztmdyatnpxpcudc22qv2625gcp0uadrnf7ggduwutp065vue9m7ekgqxk9eg".to_string()},
                    }
                },
            },
        }
